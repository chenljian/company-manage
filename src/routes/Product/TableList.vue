...
export default {
    ...
    methods: {
        ...
        showDelete(record){
            ...
            Modal.confirm({
                title: '确定删除产品?',
                content: '产品名称：' + record.name + '-' + record.specification,
                okText: '确定',
                okType: 'danger',
                cancelText: '取消',
                onOk() {
        ...
        handleAdd(fields) {
            fields.companyId = sessionStorage.getItem("companyId");
            fields.creator = sessionStorage.getItem("userName");
            console.log("新增", fields);
        ...
        handleEdit(fields) {
            fields.editor = sessionStorage.getItem("userName");
